...
def buscar_filme(cadastro_film):
    ...
    for chave in cadastro_film:
        if (buscar in cadastro_film[chave][0]):
            print(
                f'Filme: {cadastro_film[chave][0]}, Sala: {cadastro_film[chave][1]} , Horario: {cadastro_film[chave][2]}h , Valor: {cadastro_film[chave][3]}R$ , Ingressos: {cadastro_film[chave][4]}\n')
...
def att_filme(cadastro_film):
    ...
    for chave in cadastro_film:
        print(
            f'Cod: {chave}, Filme: {cadastro_film[chave][0]}, Sala: {cadastro_film[chave][1]} , Horario: {cadastro_film[chave][2]}h , Valor: {cadastro_film[chave][3]}R$ , Ingressos: {cadastro_film[chave][4]} \n')
...
def busc_filme_vendido(filmes_comprados):
    ...
    for i in range(len(filmes_comprados)):
        if filmes_comprados[i]["filme"].count(buscar):
            ...
            print('\n!!!Filme nao cadastrado ou nao vendeu ingressos!!!\n')
